...
public class BankInfoDB {
	...
	public static void updateBankInfo(String firstname, String bankName)  throws Exception{
	    Connection dbConn = null;
	    PreparedStatement pStmt = null;
	    int rowsUpdated = 0;
	     ...
	     try{
		dbConn = DBConnection.getConnection();
		pStmt = dbConn.prepareStatement("UPDATE bankdetails SET bankname=? where personid = ?");
