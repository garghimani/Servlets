...
public class PersonalInfoDB {
	...
	public static void updatePersonalInfo(String firstname, String lastname)  throws Exception{
	    Connection dbConn = null;
	    PreparedStatement pStmt = null;
	    int rowsUpdated = 0;
	     ...
	     try{
		dbConn = DBConnection.getConnection();
		pStmt = dbConn.prepareStatement("UPDATE personaldetails SET lastname=? where firstname = ?");
